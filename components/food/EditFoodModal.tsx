...
interface EditFoodModalProps {
  isVisible: { edit: boolean; id: string };
  onClose: () => void;
}

export default function EditFoodModal({ isVisible, onClose }: EditFoodModalProps) {
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          ...
          >
            ...
            <View className="mb-8 flex-row items-center justify-between">
              <Text className="text-xl font-bold text-white">Ovqatni tahrirlash</Text>
